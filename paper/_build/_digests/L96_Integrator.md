# DIGEST: PyTorch_InvObs_DA_v2_Integrator.ipynb  (slug: L96_Integrator)

## [md cell 0]
# PyTorch InvObs DA — v2 Integrator Diagnostic (Phase 3)
...
```
--- output ---
L96: grid=40, outer_dt=0.1 (dt_inner=0.01, n_inner=10)
...
## [code cell 5]
```python
N_OUTER = 200                                           # 200 outer steps = 20 model time units
RTOL    = 1e-7
ATOL    = 1e-9
...
```
--- output ---
warmed-up x0: mean=2.567, std=3.853
shapes: rk4=(200, 40), adapt=(200, 40)
divergence at t=0: 0.000e+00
divergence at t=19.9: 2.854e+01
t*  (first time ||diff|| >= 1.0): 6.30 mtu (63 outer steps)
...
--- output ---
  ...
  traj 3: t* = 6.50 mtu
  traj 4: t* = 8.30 mtu
  [cache] wrote l96_phase3_divergence_N5_T200.pt

t* summary across 5 trajectories:  median=7.70 mtu, range=[6.50, 8.30]
...
>>> FIGURE EMBEDDED: figures/L96_Integrator__cell08__out00.png
...
>>> FIGURE EMBEDDED: figures/L96_Integrator__cell10__out00.png

--- output ---
fit window: t in [0.5, 5.0] mtu
lambda     = 2.263 (1/mtu)
T_L = 1/lambda = 0.442 mtu  (paper expects ~0.6)
<Figure size 900x500 with 1 Axes>
