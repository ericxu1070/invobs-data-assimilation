...
\newcommand{\dtout}{\Delta t_{\mathrm{out}}}  % outer integration step
\newcommand{\dtin}{\Delta t_{\mathrm{in}}}    % inner integration substep
...
where single-window 4D-Var degrades. We also report honest negative results, including a
background-error standard deviation whose tuning yielded only marginal gains and an
unexpected ordering of its optimal value.
\end{abstract}

\input{_sections/intro.tex}
\input{_sections/background.tex}
\input{_sections/methods.tex}
...
\input{_sections/results_l96.tex}
\input{_sections/results_kflow.tex}

\input{_sections/discussion.tex}
